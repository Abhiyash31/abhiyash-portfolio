...
export const projects: Project[] = [
  {
    ...
    status: "shipped",
    featured: true,
    thumb: "/work/thumbs/predictive.png",
  ...
  },
  {
    ...
    status: "shipped",
    featured: true,
    thumb: "/work/thumbs/cinematch.png",
  ...
  {
    slug: "ai-codebase-qa",
    title: "RepoLens · AI Codebase Q&A",
    tagline: "Ask a repository questions, get cited answers, or an honest refusal.",
    year: "2026",
    status: "building",
    featured: false,
    thumb: "/work/thumbs/codebase-qa.png",
    role: "Solo · polishing for release",
    context: "Independent · applied AI",
    summary:
    ...
    stack: [
      { group: "App", items: ["Next.js", "TypeScript"] },
      { group: "AI", items: ["Claude API", "transformers.js embeddings", "RAG + refusal gate"] },
      { group: "Data", items: ["SQLite", "Neon pgvector", "Eval harness"] },
    ],
  },
  {
